...
<title><struts:text name="register.jsp.title" /></title>
...
<body>
	<center>
		...
		<input  style=" width: 90%; height: 35px; margin-left: 5%;margin-top: 18px;"     class="text" type="text" id="username"  name="username"   placeholder="   姓名"  required/>
			...
			<input  style=" width: 90%; height: 45px; margin-left: 5% ; margin-top: 12px; background-color:#920D0D; font-size: 20px; color: white;" type="submit" value="注册">
		</form>
		</div>
	</center>
</body>
